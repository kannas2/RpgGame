...
public class NpcChase : BaseNpc {

    public static NpcChase instance; //나중에 몬스터 마리수 올리는거 때문에.
    ...
    void Start()
    {
        ...
        base.prevCheckQwest = "ms107";   // 이전 퀘스트를 완료해야지만 클릭이가능.
        base.limitedcode = "ms109";   // 특정 퀘스트 코드 리미트. 계속 변동됨
